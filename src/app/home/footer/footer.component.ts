...
constructor(private sanitizer: DomSanitizer) {
  ...
  <head>
      <meta charset="UTF-8">
      <title>Privacy Policy - ISD MAKERS SIVAKASI</title>
  </head>
  <body>
      <h1>Privacy Policy</h1>
      <p><strong>Effective Date:</strong>10.10.2026</p>
      
      <h2>Introduction</h2>
      <p>INDIAN SCORING DIES MAKERS (SIVAKASI), hosted on Firebase Hosting by Google, operates the website at [https://indianscoringdiesmaker.web.app/]. This policy explains data practices for visitors to our static site. It applies to all users globally. [web:1]</p>
      ...
      <p>We may update this policy; check back periodically. Questions? Email rambabu.roges96@gmail.com. [web:6]</p>
  </body>
  </html>
  `; 

  this.dynamicHtml = this.sanitizer.bypassSecurityTrustHtml(privacyLet);
